...
QUERIES=("E(H|K)*E")
SUMMARY_SIZES=(250 500)
TIME_WINDOW_SIZES=(100 250 500)
STREAM_SIZES=(3776256)
TIMES_TO_LIVE=(3776256)
PROB_DISTRIBUTIONS=("real_world_data_set")
EVAL_TIMESTAMPS_COUNTS=(1000)
EVAL_TIMESTAMPS_PROB_DISTS=("uniform")
NUM_OF_RUNS=(1)
FILE_NAMES=("202307-citibike-tripdata.csv")

SEEDS=(23805 22871 5246 12748 15359 28418)
